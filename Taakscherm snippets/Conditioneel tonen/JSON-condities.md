...
Door `conditional` toe te voegen aan een component kun je met *JSON-logica* een bepaalde conditie evalueren. Afhankelijk van de uitkomt `true` of `false` wordt bepaald of een component moet worden weergegeven.  
